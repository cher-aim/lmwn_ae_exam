...
WITH restaurant_complaints AS (
    ...
    FROM {{ ref('model_mart_restaurant_related_tickets') }}
...
customer_returns AS (
    ...
    FROM {{ ref('model_mart_restaurant_related_tickets') }} mart
...
restaurant_metrics AS (
    ...
    FROM {{ ref('model_mart_restaurant_related_tickets') }} AS main
