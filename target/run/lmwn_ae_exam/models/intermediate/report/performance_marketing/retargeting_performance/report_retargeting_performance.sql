    ...
    create  table
      "ae_exam_db"."main_report_performance_marketing"."report_retargeting_performance__dbt_tmp"
...
WITH retargeting_customers AS (
    ...
    FROM "ae_exam_db"."main_data_mart"."model_mart_campaign_interactions"
...
, customer_order_before_retargeting AS (
    ...
    LEFT JOIN "ae_exam_db"."main_data_mart"."model_mart_interacting_customer_orders" oh 
