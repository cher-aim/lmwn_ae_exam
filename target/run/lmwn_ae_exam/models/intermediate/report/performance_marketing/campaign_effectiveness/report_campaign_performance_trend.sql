    ...
    create  table
      "ae_exam_db"."main_report_performance_marketing"."report_campaign_performance_trend__dbt_tmp"
...
FROM "ae_exam_db"."main_data_mart"."model_mart_campaign_interactions" mpm 
GROUP BY 
