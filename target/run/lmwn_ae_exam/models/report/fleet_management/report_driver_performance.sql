    ...
    create  table
      "ae_exam_db"."main_report_fleet_management"."report_driver_performance__dbt_tmp"
...
SELECT 
    ...
    ROUND(AVG(DATEDIFF('minute', pickup_datetime, delivery_datetime)), 2) AS avg_time_to_complete_deliveries
